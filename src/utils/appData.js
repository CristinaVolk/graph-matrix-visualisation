...
export const snackContent = {
  message:
    "The graph represents the character co-occurrences in Victor Hugo’s Les Misérables. Each colloured node represents two name or surname that appeared in the same chapter;The width of the links indicate the frequency of the characters. The colour of the nodes define the chapter of the book.                 Analysing the network using the switchers to show the maximum co-occurrence it allows the users to conclude who is the main character of the book. Filtering by freqency checkboxes let the users realize who are less/more important figures in the novel.  Surreally to understand how the life penetrates new links in the huge mankind network developing the application sitting in the cafe named Victor Hugo.",
};
